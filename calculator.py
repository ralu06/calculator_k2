...
class CalcDisplay(ttk.Frame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.lblDisplay = ttk.Label(self, text=self._value, style='my.TLabel', anchor=E, foreground="black", background='gray')
        self.lblDisplay.pack(fill=BOTH, expand=True)

    def addDigit(self, digito):
        '''
        if len(self._value) == 11 or (self._value[0] != "-" and len )
        '''
...
class CalcButton(ttk.Frame):
    def __init__(self, parent, **kwargs):
        ...
        if 'bw' in kwargs:
            ...
            bw = 1
        ''' 
        bw = kwargs['bw'] if 'bw' in kwargs else 1 #lo mismo que la variable de arriba
...
class Calculator(ttk.Frame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        CalcButton(self, text="+/-", command=self.display.positivoNegativo).grid(column=1, row=1)
